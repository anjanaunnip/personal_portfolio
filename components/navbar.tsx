        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="px-6 py-2 bg-gradient-to-r from-[#9f7aea] to-[#00d9ff] text-background rounded-full font-semibold text-sm flex items-center space-x-2 hover:shadow-lg hover:shadow-[#9f7aea]/50 transition-all"
            >
              <Download size={16} />
              <span>Resume</span>
            </motion.button>
