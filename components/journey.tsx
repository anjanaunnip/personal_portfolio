  ...
  const milestones = [
    {
      year: '2026',
      title: 'MCA Graduate',
      description: 'Completed Master of Computer Applications with strong foundation in software development.',
      icon: GraduationCap,
      position: 'left',
    },
    {
      ...
      description: 'Built multiple real-world applications using modern web technologies.',
      icon: Code2,
      position: 'right',
    },
    {
      ...
      description: 'Started exploring AI integration and intelligent software solutions.',
      icon: Zap,
      position: 'left',
    },
    {
      ...
      description: 'Built strong fundamentals in programming, databases and problem solving.',
      icon: BookOpen,
      position: 'right',
    },
  ];
